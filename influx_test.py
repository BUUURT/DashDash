...
write_api.write('test5', 'rammers', 'rammerRpi,lap=0 speed=0,rpm=0,engTemp=63.0,airTemp=72.0,gps_lat=False,gps_long=False,rotationX=66.0,rotationY=-2.6875,rotationZ=1.6875,accelX=-0.66,accelY=-0.15,accelZ=9.51')# 162010988920049140
print(a)
